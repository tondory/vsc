      ...
      <div class="hero-body">
        <div class="container has-text-centered">
          <div class="is-centered">
                ...
                <p>Budgetcat ("us", "we", or "our") operates the Budgetcat website and the Budgetcat mobile application (the "Service").</p>

                <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. Our Privacy Policy  for Budgetcat is created with the help of the <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator.php">Free Privacy Policy Generator</a>.</p>
                ...
                <p>Budgetcat uses the collected data for various purposes:</p>    
                <ul>
                ...
                <p>Budgetcat may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
                <ul>
                    <li>To comply with a legal obligation</li>
                    <li>To protect and defend the rights or property of Budgetcat</li>
                ...
                <ul>
                <li>By visiting this page on our website: https://www.Budgetcat/contact</li>
